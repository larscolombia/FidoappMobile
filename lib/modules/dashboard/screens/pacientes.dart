                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: InputTextWithIcon(
                                ...
                                onChanged: (value) => _homeController.searchPetByName(value),
                              ),
                            ),
                            const SizedBox(
                              height: 20,
                      ...
                      return SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            ...
                            // var isSelected = _homeController.selectedProfile.value == profile;
                            ...
                            return GestureDetector(
                              onTap: () {
                                ...
                                Get.toNamed(
                                  // TODO: Reemplazar esta forma de inyectar los datos de la mascota
                                  // solo debemos pasar el id de la mascota y el controlador de la vista
                                  // se encarga de obtener los datos
                                  Routes.PROFILEPET,
                                  arguments: profile, // Pasar el perfil de la mascota como argumento
                                );
                              },
